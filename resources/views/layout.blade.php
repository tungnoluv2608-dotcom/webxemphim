                            ...
                            <li class="mega dropdown">
                                @auth
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        ...
                                        <li><a title="Gói dịch vụ" href="{{ route('packages.index') }}"><i
                                                    class="fa fa-crown"></i> Gói dịch vụ</a></li>
                                        ...
                                        @if ($isAdmin)
                                            <li class="divider"></li>
                                            <li><a title="Admin Dashboard" href="{{ url('/admin') }}"><i
                                                        class="fa fa-dashboard"></i> Admin</a></li>
                                            <li><a title="Quản lý Users" href="{{ route('admin.users.index') }}"><i
                                                        class="fa fa-users"></i> Quản lý Users</a></li>
                                        @endif
